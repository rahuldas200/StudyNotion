...
const ExploreMore = () => {
  ...
  return (
    <div className='relative w-11/12 flex flex-col justify-center items-center'>
        <div className='font-semibold text-4xl text-center mb-5'>
            Unlock the 
        ...
        <div className='absolute flex flex-row gap-9 justify-between w-full -bottom-36 '>
            {
                courses.map( (element, index) => {
                    return (
                        <div key={index} 
                            className={`${index === 0 ? "bg-white text shadow-[12px_12px_0px_0px_#FAEF03] " : "bg-richblack-800 shadow-[12px_12px_0px_0px_#4242C8]"}`}>
